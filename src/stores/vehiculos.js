...
export const useVehiculoStore = defineStore("vehiculo", ()=>{
    ...
    const getVehiculos = async ()=>{ 
        try {
            return axios.get("https://admiventas.onrender.com/vehiculo")
        } catch (error) {
    ...
    const postVehiculo = async (datos)=>{
        try {
            return axios.post("https://admiventas.onrender.com/vehiculo",datos)
        } catch (error) {
    ...
    const editVehiculo = async (id, datos) => {
        try {
          return axios.put(`https://admiventas.onrender.com/vehiculo/${id}`, datos);
        } catch (error) {
